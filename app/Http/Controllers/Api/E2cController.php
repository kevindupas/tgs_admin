...
class E2cController extends Controller
{
     ...
     *                         @OA\Property(property="featured_image_url", type="string", example="https://example.com/storage/media/image.jpg", description="URL complète de l'image à la une"),
     *                         @OA\Property(property="gallery_urls", type="array", @OA\Items(type="string", example="https://example.com/storage/media/gallery-1.jpg"), description="URLs complètes des images de la galerie"),
