...
class E2cController extends Controller
{
     ...
     *                         @OA\Property(property="featured_image", type="string", description="ID du média (pour usage interne)"),
     *                         @OA\Property(property="featured_image_url", type="string", example="https://example.com/storage/media/image.jpg", description="URL complète de l'image"),
     *                         @OA\Property(property="gallery", type="array", @OA\Items(type="string"), description="IDs des médias (pour usage interne)"),
     *                         @OA\Property(property="gallery_urls", type="array", @OA\Items(type="string"), description="URLs complètes des images de la galerie"),
