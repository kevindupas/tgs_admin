...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
    class="w-5 h-5" width="24" height="24" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" fill="currentColor">
    @switch($icon)
        @case('align-center')
        ...
        @case('font-size')
            <path fill="currentColor" d="M3 18h3l.7-2h3.6l.7 2h3L9.5 6h-3L3 18zm4.7-5L8.5 10l.8 3H7.7z" />
            <path fill="currentColor" d="M12 14h2l.5-1.5h2.5l.5 1.5h2L16.5 8h-2L12 14zm3-3l.5-1.5.5 1.5H15z" />
        @break
